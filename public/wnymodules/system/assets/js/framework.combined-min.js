...
function($) {
    ...
    var Request = function(element, handler, options) {
        ...
        if (options.browserValidate !== undefined && typeof document.createElement('input').reportValidity === 'function' && !!$form.length && !$form.get(0).checkValidity()) {
        ...
        var requestOptions = {
            ...
            error: function(jqXHR, textStatus, errorThrown) {
                var data = {},
                    errorMsg, updatePromise = $.Deferred();
            ...
            handleValidationMessage: function(message, fields) {
                ...
                $.each(fields, function focusErrorField(fieldName, fieldMessages) {
                    ...
                    var fieldNameOptions = ['[name="' + fieldNameRaw + '"]', '[name="' + fieldNameRaw + '[]"]', '[name$="' + fieldNameArr + '"]', '[name$="' + fieldNameArr + '[]"]'];
