...
<body>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('pcm-content.index') }}" + '/' + id + '/edit', function(data) {
                $('#editId').val(data.id);
        ...
        $('#editContentForm').on('submit', function(e) {
            ...
            $.ajax({
                type: "PUT",
                url: "{{ route('pcm-content.update', '') }}/" + id,
        ...
        $('#confirmDelete').on('click', function() {
            ...
            $.ajax({
                type: "DELETE",
                url: "{{ route('pcm-content.destroy', '') }}/" + id,
                data: {
                    _token: '{{ csrf_token() }}'
                },
                success: function(response) {
