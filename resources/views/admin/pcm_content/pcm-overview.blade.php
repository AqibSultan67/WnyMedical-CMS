...
<body>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('pcm-overview.index') }}" + '/' + id + '/edit', function(data) {
                $('#editId').val(data.id);
        ...
        $('#editContentForm').on('submit', function(e) {
            ...
            $.ajax({
                type: "PUT",
                url: "{{ route('pcm-overview.update', '') }}/" + id,
        ...
        $('#confirmDelete').on('click', function() {
            ...
            $.ajax({
                type: "DELETE",
                url: "{{ route('pcm-overview.destroy', '') }}/" + id,
                data: {
                    _token: '{{ csrf_token() }}'
                },
                success: function(response) {
